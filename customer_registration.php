            ...
            <li>
                ...
                <li>
                  <a href="cart.php" class="">
                   ...
                   <li>
                   <a class="active" href="#customer_registration.php"><i class="fa fa-user-plus"></i>s'enregistrer</a></li>
                   <li>
                   <?php
  ...
  <div class="container">
    <div class="col-md-12">
      <ul class="breadcrumb">
        ...
        <li><span>Inscription client</span></li>
        ...
        <div class="roup">
          ...
          <div class="text-center">
            <button type="submit" name="submit" class="btn btn-primary">
              ...
              <i class="fa fa-user-md"></i> s'enregistrer
            </button>
          </div>
        </form>
      </div>
