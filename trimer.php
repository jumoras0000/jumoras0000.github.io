      ...
      if(!isset($_GET['p_cat'])){
        if(!isset($_GET['cat_id'])){
          ...
          while ($row=mysqli_fetch_array($run_pro)) {
            ...
            <p class='pric'>  FCFA $pro_price </p>
            <p class='buttons'>
            <a href='details.php?pro_id=$pro_id' class='btn btn-default'>Voir les details</a>
...
<!--Page Session Start-->
            ...
            <ul class="pagination">
              <?php
                ...
                echo "<li> <a  href='trimer.php?page=1' >".'Premiere Page'." </a> </li>";
                for($i=1; $i<=$total_pages; $i++){
                   echo "<li> <a href='trimer.php?page=".$i."'> ".$i." </a> </li>";
                 };
                 echo "<li> <a href='trimer.php?page=$total_pages'>".'Derniere Page'." </a> </li>";
                }
              } 
                ?>
</ul>
