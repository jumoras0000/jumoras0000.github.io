...
<nav class="navbar"> 
     ...
     <ul >
            ...
            <li><a class="active" href="trimer.php">BOUTIQUE</a></li>
            ...
            <li>
                ...
                <li>
                  <a href="cart.php" class="">
                   ...
                   <li>
                   <a href="customer/my_account.php"><i class="fa fa-user-circle"></i>Mon compte</a></li> 
                     
                   <li>
                   <a href="cart.php"><i class="fa fa-shopping-cart"></i>FCFA</a></li>
  ...
  <div class="container">
    <div class="col-md-12">
      <ul class="breadcrumb">
        ...
        <li><span>Details du Produit</span></li>
...
<div class="co-md-6">
  <div class="bx">
   ...
   <?php addCart(); ?>
    ...
    <div class="form-group">
      <label class="col-md-5 control-label" >choisir la couleur</label>
      <div class="col-md-7">
    ...
    <p class="price">FCFA</i><?php echo $p_price; ?></p>
    <p class="text-center buttons">
      <button class="btn-prim" type="submit"><i class=" fa fa-shopping-cart">Ajouter au Panier</i></button>
    </p>
  </form>
  </div>
  <div class="col-xs-4">
